...
export const GAME_LIST = [
  ...
  },
  {
    ...
    rules: [
      ...
      'שישה שלבים, מהמתחילים ועד האגדות, ועוד חידה יומית אחת לכולם',
    ],
  ...
  },
  {
    id: 'chain',
    title: 'שרשרת',
    subtitle: 'שרשרת אחת ביום. כמה מהר תחברו אותה?',
    icon: '🔗',
    Component: Chain,
    ...
    rules: [
      ...
      'רמז חושף את האות הבאה ומוסיף 3 שניות. אין הגבלה על מספר הרמזים',
      'התוצאה היא הזמן הכולל. שרשרת אחת ביום, אותה שרשרת לכולם',
    ],
